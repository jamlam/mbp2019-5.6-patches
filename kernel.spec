...
Patch603:  3002-applesmc-make-io-port-base-addr-dynamic.patch
Patch604:  3003-applesmc-switch-to-acpi_device-from-platform.patch
Patch605:  3004-applesmc-key-interface-wrappers.patch
Patch606:  3005-applesmc-basic-mmio-interface-implementation.patch
Patch607:  3006-applesmc-fan-support-on-T2-Macs.patch

  # T2 USB Keyboard/Touchpad support
Patch608:  4001-touchpad.patch
Patch609:  4002-keyboard-backlight.patch

  # Broadcom Wifi rambase debugging additions
Patch610:  5001-brcmfmac-move-brcmf_mp_device-into-its-own-header.patch

  # MBP Peripheral support
Patch612:  camera.patch
Patch613:  wifi.patch
